...
from sql.bus_queries import MERGE_SCD2_CITY_BUS_STATION, INSERT_UPDATED_CITY_BUS_STATION
...
with DAG(
    ...
    merge_into_silver_scd2 = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": MERGE_SCD2_CITY_BUS_STATION.format(
                    project_id="{{ var.value.gcp_project_id }}",
                    dataset_id="bus_silver",
                    table_id="city_bus_station",
                    staging_table_id="city_bus_station_staging",
                ),
                "useLegacySql": False,
            }
        },
    ...
    insert_updated_records = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": INSERT_UPDATED_CITY_BUS_STATION.format(
                    project_id="{{ var.value.gcp_project_id }}",
                    dataset_id="bus_silver",
                    table_id="city_bus_station",
                    staging_table_id="city_bus_station_staging",
